            ...
            >
              <div className="relative z-10 transition-colors duration-500 group-hover:text-white">
                ...
                <p className="text-sm md:text-base group-hover:text-white/90">
                  نسعى في جمعية رسالة إلى نشر ثقافة التطوع والإيجابية داخل المجتمع، وزرع روح الانتماء، ومكافحة الأنانية ومفهوم "وأنا مالي"، بالإضافة إلى التصدي للأفكار السلبية.
